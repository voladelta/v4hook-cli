...
The chief treats the report as a claim. Accepted must-fix findings move to a fresh fixer. Rejected
findings retain a rationale in the ledger.
...
Give a fresh verifier the parent contract, frozen manifest, reviewer-clean report, exact candidate
